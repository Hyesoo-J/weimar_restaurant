...
public class RestaurantJFrame extends javax.swing.JFrame
{
    ...
    private void initComponents() {
       ...
       jTabbedPane1.addTab("Reservations", jPanel2);
        ...
        jLabel1.setFont(new java.awt.Font("Century", 0, 35)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(153, 0, 0));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Weimar Restaurant");
    ...
    public void addReservation()
    {
        ...
        JComboBox day = new javax.swing.JComboBox();
        ...
        if (n == JOptionPane.YES_OPTION)
        {
            ...
            String inputDate = year.getSelectedItem().toString() + "." +
            				   month.getSelectedItem().toString() + "." +
            				   day.getSelectedItem().toString();
            String inputTime = hours.getSelectedItem().toString() + ":" +
                               minutes.getSelectedItem().toString();
            
            iterator.makeNewReservation(new ReservationInfo(inputName+"  ", inputEmail+"   ", inputDate, inputTime));
            displayReservation();
        }
    }
